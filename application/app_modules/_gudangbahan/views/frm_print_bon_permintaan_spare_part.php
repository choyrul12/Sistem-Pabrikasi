  ...
  <body>
    <div>
      <div class="header">
        ...
        <center>
          <h3>Bon Permintaan Spare Part</h3>
        </center>
        <div style="float:left; width:50%; border:0; margin-top : 50px;">
          <table width="100%" style="border:0;">
            <tr>
              ...
              <td style="border:0;"><?php echo $DataPermintaan[0]["kd_permintaan_spare_part"]; ?></td>
            </tr>
            <tr>
      ...
      <table width='100%' id="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><center><?php echo $arrValue["nm_spare_part"]." ".$arrValue["ukuran"]; ?></center></td>
            <td>
              <center>
                <?php
