    ...
    <section class="content">
      <div class="box box-primary">
        <div class="box-header with-border">
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalTambahBahanBaru" data-backdrop="static" onclick="modalTambahBahanBakuBaru('MINYAK');"><span class="fa fa-plus"></span> Tambah Minyak Baru</button>
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-target="#modalTambahPembelianBahanBaru" data-backdrop="static" onclick="modalTambahPembelianBahanBaku('MINYAK');"><span class="fa fa-plus"></span> Tambah Pembelian Minyak</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-target="#modalCheckHistory" data-backdrop="static" onclick="modalCheckHistory('MINYAK');"><span class="fa fa-search"></span> Cek History Minyak</button>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-target="#modalKoreksian" data-backdrop="static" onclick="modalKoreksi('MINYAK');" style="margin-top:3px;"><span class="fa fa-check"></span> Koreksian Minyak</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-target="#modalPengeluaran" data-backdrop="static" onclick="modalPengeluaran('MINYAK')" style="margin-top:3px;"><span class="fa fa-sign-out"></span> Pengerluaran Minyak</button>
          <button type="button" class="btn btn-md btn-flat bg-olive" data-toggle="modal" data-target="#modal_cariBonPermintaan" data-backdrop="static" onclick="modalCariBonPermintaan('MINYAK');" style="margin-top:3px;"><span class="fa fa-list"></span> Bon Permintaan Bahan</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-target="#modalTambahDataAwal" data-backdrop="static" onclick="modalTambahDataAwal('MINYAK');"><span class="fa fa-plus"></span> Tambah Data Awal</button>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="alert alert-info fade" role="alert" id="alertApproveMinyak">
                  <h4>
                    <i class="icon fa fa-check"></i>
                    <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" onclick="modalApprove('CETAK|SABLON','MINYAK');">
                      Ada Permintaan / Kembalian Minyak Dari Cetak / Sablon
                    </a>
                  </h4>
                </div>
              </div>
              <div class="col-md-6">
                <div class="alert alert-success fade" role="alert" id="alertApprovePembelian">
                  <h4>
                    <i class="icon fa fa-check"></i>
                    <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" onclick="modalApprovePembelian('MINYAK')">
                      Ada Barang Masuk Dari Pembelian
                    </a>
                  </h4>
                </div>
              </div>
              <div class="col-md-6" style="display: none; cursor: pointer;" id="alertPermintaanMinyakSablon">
                <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalPermintaanBahanSablon" onclick="modalPermintaanBahanSablon('Minyak')">
                <div class="alert alert-info">
                  <h4>Ada Permintaan Minyak Dari Sablon</h4>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <table class="table table-responsive table-striped" id="tableDataMasterMinyak">
                <thead>
                  <th>Id</th>
                  <th>Nama Minyak</th>
                  <th>Stok</th>
              ...
              <table class="table table-responsive table-striped table-bordered" id="tableDataHistoryMinyak" style="display:none;">
                <thead>
                  <th>Tanggal</th>
                  <th>Jumlah Barang</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue" id="modalTitleTambahMinyakBaru">Tambah Minyak Baru</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <table class="table table-responsive">
                <tr>
                  <td width="20%">Kode Minyak</td>
                  <td width="1%">:</td>
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" class="form-control" id="txtKdBahan" placeholder="Masukan Kode Minyak" readonly>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" class="form-control" id="txtNamaBahanBaru" placeholder="Masukan Nama Minyak">
                    </div>
                  </td>
                </tr>
                <tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success pull-right" id="btnSimpanBahanBaru">Simpan Minyak Baru</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-primary">Tambah Pembelian Minyak Baru</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                <legend>Formulir Permintaan Pembelian Minyak</legend>
                <table class="table table-responsive">
                  <tr>
                ...
                <button type="button" class="btn btn-md btn-flat btn-warning pull-right" onclick="resetFormPembelian('MINYAK');">Batal</button>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="saveDanKirimPermintaan('MINYAK');"><span class="fa fa-check"></span> Kirim Permintaan</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-primary">Cari History Minyak</h4>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="searchHistory('MINYAK');"><span class="fa fa-search"></span> Cari History</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Koreksi Minyak</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                <legend>Formulir Koreksi Minyak</legend>
                <table class="table table-responsive">
                  <tr>
                    <td width="20%">Tanggal</td>
                    <td width="1%">:</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control" id="txtNamaBahan" placeholder="Nama Minyak Akan Tampil Otomatis" readonly>
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <button type="button" class="btn btn-md btn-flat btn-primary pull-right" id="btnAddKoreksi" onclick="saveCartKoreksi('MINYAK')"><span class="fa fa-plus"></span> Simpan</button>
              ...
              <fieldset>
                <legend>Daftar Koreksi Minyak</legend>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="saveKoreksi('MINYAK');"><span class="fa fa-check"></span> Selesai</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="modalPengeluaran" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
                ...
                <div class="col-md-12">
                  <table class="table table-responsive">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <select class="form-control" id="cmbBarang1"></select>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="form-group">
                          <select class="form-control" id="keterangan">
                            ...
                            <option value="PENGAMBILAN MESIN POTONG (CUCI KARET)">PENGAMBILAN MESIN POTONG (CUCI KARET)</option>
                            <option value="PENGAMBILAN MESIN EXTRUDER (CUCI MESIN)">PENGAMBILAN MESIN EXTRUDER (CUCI MESIN)</option>
                            <option value="PENGAMBILAN MESIN BUBUT">PENGAMBILAN MESIN BUBUT</option>
                            <option value="PENGAMBILAN UNTUK HAPUS CETAKAN">HAPUS CETAKAN</option>
                            <option value="PENGAMBILAN SABLON (HAPUS CETAKAN)">PENGAMBILAN SABLON (HAPUS CETAKAN)</option>
                            <option value="PENGAMBILAN GUDANG ZIPPER (HAPUS CETAKAN)">PENGAMBILAN GUDANG ZIPPER (HAPUS CETAKAN)</option>
                            <option value="PENGAMBILAN ZIPPER">PENGAMBILAN ZIPPER</option>
                  ...
                  <div class="col-md-4 pull-right">
                    <button type="button" class="btn btn-md btn-flat btn-primary pull-right" id="btnAddPengeluaran" onclick="savePengeluaranTemp('MINYAK')"><i class="fa fa-plus"></i> Tambah</button>
                    <button type="button" class="btn btn-md btn-flat btn-warning pull-right" onclick="resetFormPengeluaran('MINYAK')"><i class="fa fa-remove"></i> Batal</button>
                  </div>
                </div>
                <div class="col-md-12">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="savePengeluaran('MINYAK')"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="modalPengeluaran" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
                ...
                <div class="col-md-12">
                  <table class="table table-responsive">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group">
                          <input type="text" id="keterangan" class="form-control" placeholder="Masukan Keterangan">
                        </div>
                      </td>
                    </tr>
                  </table>
                  ...
                  <div class="col-md-4 pull-right">
                    <button type="button" class="btn btn-md btn-flat btn-primary pull-right" id="btnAddPengeluaran" onclick="savePengeluaranTemp('CAT_CAMPUR')"><i class="fa fa-plus"></i> Tambah</button>
                    <button type="button" class="btn btn-md btn-flat btn-warning pull-right" onclick="resetFormPengeluaran('CAT_CAMPUR')"><i class="fa fa-remove"></i> Batal</button>
                  </div>
                </div>
                <div class="col-md-12">
                  <table class="table table-responsive table-striped" id="tableListPengeluaran">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="savePengeluaran('CAT_CAMPUR')"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="modalTambahDataAwal" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnSimpanDataAwal" class="btn btn-md btn-flat btn-success" onclick="saveDataAwal('MINYAK')"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
