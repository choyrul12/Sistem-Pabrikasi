    ...
    <section class="content">
      <div class="box box-primary">
        <div class="box-header with-border">
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalTambahBahanBaru" data-backdrop="static" onclick="modalTambahBahanBakuBaru('BIJI_WARNA');"><span class="fa fa-plus"></span> Tambah Biji Warna Baru</button>
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-target="#modalTambahPembelianBahanBaru" data-backdrop="static" onclick="modalTambahPembelianBahanBaku('BIJI_WARNA');"><span class="fa fa-plus"></span> Tambah Pembelian Biji Warna</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-target="#modalCheckHistory" data-backdrop="static" onclick="modalCheckHistory('BIJI_WARNA');"><span class="fa fa-search"></span> Cek History Biji Warna</button>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-target="#modalKoreksian" data-backdrop="static" onclick="modalKoreksi('BIJI_WARNA');" style="margin-top:3px;"><span class="fa fa-check"></span> Koreksian Biji Warna</button>
          <button type="button" class="btn btn-md btn-flat bg-olive" data-toggle="modal" data-target="#modal_cariBonPermintaan" data-backdrop="static" onclick="modalCariBonPermintaan('BIJI_WARNA');" style="margin-top:3px;"><span class="fa fa-list"></span> Bon Permintaan Bahan</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-target="#modalTambahDataAwal" data-backdrop="static" onclick="modalTambahDataAwal('BIJI_WARNA');"><span class="fa fa-plus"></span> Tambah Data Awal</button>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="alert alert-info fade" role="alert" id="alertApproveBijiWarnaExtruder">
                  <h4>
                    <i class="icon fa fa-check"></i>
                    <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" onclick="modalApprove('EXTRUDER','BIJI WARNA');">
                      Ada Permintaan / Kembalian Biji Warna Dari Extruder
                    </a>
                  </h4>
                </div>
              </div>
              <div class="col-md-6">
                <div class="alert alert-success fade" role="alert" id="alertApprovePembelian">
                  <h4>
                    <i class="icon fa fa-check"></i>
                    <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" onclick="modalApprovePembelian('BIJI WARNA')">
            ...
            <div class="col-md-12">
              <table class="table table-responsive table-striped" id="tableDataMasterBijiWarna">
                <thead>
                  <th>Id</th>
                  <th>Nama Biji Warna</th>
                  <th>Stok</th>
                  <th>Action</th>
                </thead>
              </table>
              ...
              <table class="table table-responsive table-striped table-bordered" id="tableDataHistoryBijiWarna" style="display:none;">
                <thead>
                  <th>Tanggal</th>
                  <th>Jumlah Barang</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue" id="modalTitleTambahBijiWarnaBaru">Tambah Biji Warna Baru</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <table class="table table-responsive">
                <tr>
                  <td width="20%">Kode Biji Warna</td>
                  <td width="1%">:</td>
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" class="form-control" id="txtKdBahan" placeholder="Masukan Kode Biji Warna" readonly>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Nama Biji Warna</td>
                  <td>:</td>
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" class="form-control" id="txtNamaBahanBaru" placeholder="Masukan Nama BijiWarna">
                    </div>
                  </td>
                </tr>
                <tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success pull-right" id="btnSimpanBahanBaru">Simpan BijiWarna Baru</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-primary">Tambah Pembelian BijiWarna Baru</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                <legend>Formulir Permintaan Pembelian Biji Warna</legend>
                <table class="table table-responsive">
                  <tr>
                ...
                <button type="button" class="btn btn-md btn-flat btn-warning pull-right" onclick="resetFormPembelian('BIJI WARNA');">Batal</button>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="saveDanKirimPermintaan('BIJI WARNA');"><span class="fa fa-check"></span> Kirim Permintaan</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-primary">Cari History Biji Warna</h4>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="searchHistory('BIJI_WARNA');"><span class="fa fa-search"></span> Cari History</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Koreksi Biji Warna</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                <legend>Formulir Koreksi Biji Warna</legend>
                <table class="table table-responsive">
                  <tr>
                    <td width="20%">Tanggal</td>
                    <td width="1%">:</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control" id="txtNamaBahan" placeholder="Nama Biji Warna Akan Tampil Otomatis" readonly>
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <button type="button" class="btn btn-md btn-flat btn-primary pull-right" id="btnAddKoreksi" onclick="saveCartKoreksi('BIJI_WARNA')"><span class="fa fa-plus"></span> Simpan</button>
              ...
              <fieldset>
                <legend>Daftar Koreksi Biji Warna</legend>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="saveKoreksi('BIJI_WARNA');"><span class="fa fa-check"></span> Selesai</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="modalTambahDataAwal" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnSimpanDataAwal" class="btn btn-md btn-flat btn-success" onclick="saveDataAwal('BIJI_WARNA')"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
