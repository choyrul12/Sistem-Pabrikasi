    ...
    <section class="content">
      <div class="box box-primary">
        <div class="box-header with-border">
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalTambahBahanBaru" data-backdrop="static" onclick="modalTambahBahanBakuBaru('CAT_CAMPUR');"><span class="fa fa-plus"></span> Tambah Cat Campur Baru</button>
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-target="#modalTambahPembelianBahanBaru" data-backdrop="static" onclick="modalTambahPembelianBahanBaku('CAT_CAMPUR');"><span class="fa fa-plus"></span> Tambah Pembelian Cat Campur</button>
          <button type="button" class="btn btn-md btn-flat btn-info" data-toggle="modal" data-target="#modalCheckHistory" data-backdrop="static" onclick="modalCheckHistory('CAT_CAMPUR');"><span class="fa fa-search"></span> Cek History Cat Campur</button>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-target="#modalKoreksian" data-backdrop="static" onclick="modalKoreksi('CAT_CAMPUR');" style="margin-top:3px;"><span class="fa fa-check"></span> Koreksian Cat Campur</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-target="#modalPengeluaran" data-backdrop="static" onclick="modalPengeluaran('CAT_CAMPUR')" style="margin-top:3px;"><span class="fa fa-sign-out"></span> Pengerluaran Cat Campur</button>
          <button type="button" class="btn btn-md btn-flat bg-olive" data-toggle="modal" data-target="#modal_cariBonPermintaan" data-backdrop="static" onclick="modalCariBonPermintaan('CAT_CAMPUR');" style="margin-top:3px;"><span class="fa fa-list"></span> Bon Permintaan Bahan</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-target="#modalTambahDataAwal" data-backdrop="static" onclick="modalTambahDataAwal('CAT_CAMPUR');"><span class="fa fa-plus"></span> Tambah Data Awal</button>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="alert alert-info fade" role="alert" id="alertApproveCatCampur">
                  <h4>
                    <i class="icon fa fa-check"></i>
                    <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" onclick="modalApprove('CETAK|SABLON','CAT CAMPUR');">
                      Ada Permintaan / Kembalian Cat Campur Dari Cetak
                    </a>
                  </h4>
                </div>
              </div>
              <div class="col-md-6">
                <div class="alert alert-success fade" role="alert" id="alertApprovePembelian">
                  <h4>
                    <i class="icon fa fa-check"></i>
                    <a href="#" style="text-decoration:none;" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" onclick="modalApprovePembelian('CAT CAMPUR')">
            ...
            <div class="col-md-12">
              <table class="table table-responsive table-striped" id="tableDataMasterCatCampur">
                <thead>
                  <th>Id</th>
                  <th>Nama Cat Campur</th>
                  <th>Stok</th>
                  <th>Action</th>
                </thead>
              </table>
              ...
              <table class="table table-responsive table-striped table-bordered" id="tableDataHistoryCatCampur" style="display:none;">
                <thead>
                  <th>Tanggal</th>
                  <th>Jumlah Barang</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue" id="modalTitleTambahCatCampurBaru">Tambah Cat Campur Baru</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <table class="table table-responsive">
                <tr>
                  <td width="20%">Kode Cat Campur</td>
                  <td width="1%">:</td>
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" class="form-control" id="txtKdBahan" placeholder="Masukan Kode Cat Campur" readonly>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Nama Cat Campur</td>
                  <td>:</td>
                  <td>
                    <div class="form-group has-warning">
                      <input type="text" class="form-control" id="txtNamaBahanBaru" placeholder="Masukan Nama Cat Campur">
                    </div>
                  </td>
                </tr>
                <tr>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success pull-right" id="btnSimpanBahanBaru">Simpan Cat Campur Baru</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-primary">Tambah Pembelian Cat Campur Baru</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                <legend>Formulir Permintaan Pembelian Cat Campur</legend>
                <table class="table table-responsive">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="txtNamaBahan" class="form-control" placeholder="Akan Muncul Otomatis Saat Cat Campur Sudah Dipilih" readonly>
                      </div>
                    </td>
                  </tr>
                  <tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-primary">Cari History Cat Campur</h4>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="searchHistory('CAT_CAMPUR');"><span class="fa fa-search"></span> Cari History</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Koreksi Cat Campur</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <fieldset>
                <legend>Formulir Koreksi Cat Campur</legend>
                <table class="table table-responsive">
                  <tr>
                    <td width="20%">Tanggal</td>
                    <td width="1%">:</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" class="form-control" id="txtNamaBahan" placeholder="Nama Cat Campur Akan Tampil Otomatis" readonly>
                      </div>
                    </td>
                  </tr>
                  <tr>
                ...
                <button type="button" class="btn btn-md btn-flat btn-primary pull-right" id="btnAddKoreksi" onclick="saveCartKoreksi('CAT_CAMPUR')"><span class="fa fa-plus"></span> Simpan</button>
              ...
              <fieldset>
                <legend>Daftar Koreksi Cat Campur</legend>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="saveKoreksi('CAT_CAMPUR');"><span class="fa fa-check"></span> Selesai</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="modalTambahDataAwal" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnSimpanDataAwal" class="btn btn-md btn-flat btn-success" onclick="saveDataAwal('CAT_CAMPUR')"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
