        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalTambahPengambilan" data-backdrop="static" onclick="modalTambahPengambilanPotong('POLOS');"><i class="fa fa-plus"></i> Tambah Pengambilan</button>
              ...
              <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-target="#modalTambahPengambilanTertinggal" data-backdrop="static" onclick="modalTambahPengambilanPotongTertinggal('POLOS');"><i class="fa fa-search"></i> Tambah Pengambilan Tertinggal</button>
            </div>
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
        ...
        <div class="modal-dialog modal-lg" style="width:100%; height:100%; margin:0; padding:0;">
          <div class="modal-content" style="width:100%; height:100%;">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Tambah Pengambilan Barang Di Extruder</h4>
            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Cari History Pengambilan Extruder</h4>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="searchPengambilanPotong('EXTRUDER');"><i class="fa fa-search"></i> Cari Pengambilan</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg" style="width:100%; height:100%; margin:0; padding:0;">
          <div class="modal-content" style="width:100%; height:100%;">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Tambah Pengambilan Barang Di Extruder (Tertinggal)</h4>
            </div>
            <div class="modal-body" style="height:87%; overflow-y:scroll;">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <input type="text" id="txtStatusPengambilanTertinggal" class="form-control" value="EXTRUDER" readonly>
                        </div>
                      </td>
                    </tr>
                  </table>
        ...
        <div class="modal-dialog modal-lg" style="width:100%; height:100%; margin:0; padding:0;">
          <div class="modal-content" style="width:100%; height:100%;">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Edit Pengambilan Barang Di Extruder</h4>
            </div>
