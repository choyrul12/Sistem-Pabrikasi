        ...
        function addRencana(){
          ...
          if (!kd_sablon || !nm_operator || !tgl_rencana || !jml_rencana) {
            ...
            $.ajax({
              ...
              data : {kd_ppic : kd_ppic, kd_sablon : kd_sablon, kd_gd_hasil : kd_gd_hasil, customer : customer, merek : merek, tgl_rencana : tgl_rencana, ukuran : ukuran, warna_plastik : warna_plastik, warna_sablon : warna_sablon, nm_operator : nm_operator, jml_permintaan : jml_permintaan, jml_rencana : jml_rencana},
              success:function(response){
                if(jQuery.trim(response) === "Berhasil"){
                  buatRencana(kd_ppic);
