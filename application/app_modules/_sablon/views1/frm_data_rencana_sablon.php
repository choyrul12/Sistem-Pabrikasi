...
<script>
  ...
  function addInput()
  {
    if (i > 10) {
      ...
      $("<div class='col-md-12'></div><div class='form-group col-md-4'><select class='form-control' name='warna_cat[]' id='warna_cat'><option value=''>Warna Cat "+i+"</option><?php foreach ($cat->result_array() as $c):?><option value='<?php echo $c['kd_gd_bahan']?>'> <?php echo $c['nm_barang']?> (<?php echo $c['warna']?>)</option><?php endforeach; ?></select></div><div class='form-group col-md-3' style='width:217px; padding-right:0px;'><input type='number' class='form-control' value='' placeholder='Jumlah Cat "+i+"' name='jum_cat[]' id='jum_cat' required></div><div class='form-group col-md-1' style='width:100px;'><select class='form-control' name='satuan_cat[]'><option value='Kg'>Kg</option><option value='Ons'>Ons</option></select></div><div class='form-group col-md-3' style='width:217px; padding-right:0px;'><input type='number' class='form-control' value='' placeholder='Sisa Cat "+i+"' name='sisa_cat[]' id='sisa_cat' required></div><div class='form-group col-md-1' style='width:100px;'><select class='form-control' name='satuan_sisaCat[]'><option value='Kg'>Kg</option><option value='Ons'>Ons</option></select></div>").appendTo("#dynamicInput"); i++;
    }
  }
</script>
