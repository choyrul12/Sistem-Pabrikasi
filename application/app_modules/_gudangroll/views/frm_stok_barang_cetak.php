<div class="content-wrapper">
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalTambahBarangBaru" data-backdrop="static" onclick="modalTambahBarangBaru('CETAK')"><i class="fa fa-plus"></i> Tambah Barang Baru</button>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-target="#modalCariHistoryGudangRoll" data-backdrop="static"  onclick="modalCariHistory('CETAK')"><i class="fa fa-search"></i> Cari History Stok</button>
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-target="#modalTambahDataAwal" data-backdrop="static" onclick="modalTambahDataAwal('CETAK')"><i class="fa fa-plus"></i> Tambah Data Awal</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-target="#modalTambahSelisihBarang" data-backdrop="static" onclick="modalTambahSelisihBarang('CETAK')"><i class="fa fa-plus"></i> Tambah Selisih Barang</button>
        </div>
        <div class="col-md-12" style="margin-top : 10px;" id="alertWrapper">
          <div class="col-md-6" style="display: block;" id="alertPermintaanRollCetak">
            <div class="alert alert-danger" data-toggle="modal" data-target="#modalApprove" data-backdrop="static" style="cursor:pointer;" onclick="datatablesApprovePermintaan('CETAK');">
              <h4>
                <i class="icon fa fa-info"></i>
                <a href="#" style="text-decoration:none;">Ada Permintaan Dari Potong</a>
              </h4>
            </div>
          </div>
          <div class="col-md-6" style="display: none;" id="alertHasilCetak">
            ...
            <div class="alert alert-success" data-toggle="modal" data-target="#modalApproveHasilCetak" data-backdrop="static" style="cursor:pointer;" onclick="datatablesApproveHasilCetak();">
              <h4>
                <i class="icon fa fa-info"></i>
                <a href="#" style="text-decoration:none;">Ada Hasil Dari Cetak</a>
              </h4>
            </div>
          </div>
        </div>
        <div class="col-md-12" style="margin-top : 10px;" id="masterContainerRoll">
          <table class="table table-responsive table-striped" id="tableDataMasterGudangRollCetak">
            <thead>
              <th>Id</th>
              <th>Warna</th>
              <th>Jenis</th>
        ...
        <div class="col-md-12" id="historyContainerRoll" style="display:none; margin-top:10px;">
          ...
          <div class="col-md-4" id="infoFlowWrapper2">
            <div class="info-box" style="position:relative;">
              ...
              <div class="info-box-content">
                <span class="info-box-number text-blue">Masuk Dari Cetak</span>
                <span class="info-box-text text-blue" id="textMasukBeratCetak">Berat : 10000</span>
                <span class="info-box-text text-blue" id="textMasukBobinCetak">Bobin : 10000</span>
                <span class="info-box-text text-blue" id="textMasukPayungCetak">Payung : 10000</span>
                <span class="info-box-text text-blue" id="textMasukPayungKuningCetak">Payung Kuning : 10000</span>
              </div>
            </div>
            <div class="info-box" style="position:relative;">
          ...
          <div class="col-md-12" style="margin-top:30px;">
            <h2 class="text-blue">Detail Masuk Dari Cetak</h2>
          </div>
          <table class="table table-responsive table-striped" id="tableHistoryGudangRoll_Cetak">
            <thead>
              <th>Tanggal</th>
              <th>Berat</th>
              <th>Payung</th>
              ...
              <div class="modal-body" style="height:500px; overflow-y:scroll;">
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group has-warning">
                        <input type="text" id="cmbMerek" class="form-control" placeholder="Masukan Merek">
                      </div>
                    </td>
                  </tr>
                </table>
        ...
        <div class="modal fade" id="modalCariHistoryGudangRoll" role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" id="btnCariHistory" class="btn btn-md btn-flat btn-success" onclick="searchHistoryRoll('CETAK');"><i class="fa fa-search"></i> Cari</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="modalTambahSelisihBarang" role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" id="btnSaveSelisihBarang" class="btn btn-md btn-flat btn-success" onclick="saveTambahSelisihBarang('CETAK');"><i class="fa fa-check"></i> Simpan</button>
                <button type="button" id="btnReset" class="btn btn-md btn-flat btn-danger" onclick="resetFormTambahSelisihBarang('CETAK')"><i class="fa fa-remove"></i> Batal</button>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="col-md-12" id="tableApprovePermintaan">
                    ...
                    <div class="nav-tabs-custom">
                      <ul class="nav nav-tabs">
                        ...
                        <!-- <li><a href="#SisaPotongHariIni" data-toggle="tab" aria-expanded="false" onclick="datatablesApproveSisaPotongHariIni('CETAK');">Sisa Potong Hari Ini</a></li> -->
                      </ul>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <center style="margin-top:10px;">
                                <button type="button" id="btnApprovePermintaanPOTONG" class="btn btn-md btn-flat btn-success" onclick="saveApprovePengembalianPotong('CETAK');"><i class="fa fa-check"></i> Approve</button>
                              </center>
                            </div>
                          </div>
                        </div>
                        <div class="tab-pane" id="SisaPotongHariIni">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <center style="margin-top:10px;">
                                <button type="button" id="btnApproveSisaHariIniPOTONG" class="btn btn-md btn-flat btn-success" onclick="saveApproveSisaPotongHariIni('CETAK');"><i class="fa fa-check"></i> Approve</button>
                              </center>
                            </div>
                          </div>
                        </div>
                        <!-- <div class="tab-pane" id="PermintaanCetak">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <center style="margin-top:10px;">
                                <button type="button" id="btnApprovePermintaanCETAK" class="btn btn-md btn-flat btn-success"><i class="fa fa-check"></i> Approve</button>
                              </center>
                            </div>
                          </div>
                        </div> -->
        ...
        <div class="modal fade" id="modalApproveHasilCetak" role="dialog" tabindex="-1">
          <div class="modal-dialog modal-lg" style="width:100%; height:100%; margin:0; padding:0;">
            <div class="modal-content" style="width:100%; height:100%;">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" data-target="#modalApproveHasilCetak">&times;</button>
                <h4 class="modal-title text-blue">Silahkan Approve Hasil Cetak</h4>
              </div>
              <div class="modal-body" style="height:83%; overflow-y:scroll;">
                <div class="row">
                  <div class="col-md-12">
                    <table class="table table-responsive table-striped" id="tableApproveHasilCetak">
                      <thead>
                        <th>Ukuran</th>
                        <th>Merek</th>
                        <th>Warna</th>
                    ...
                    <center style="margin-top:10px;">
                      <button type="button" id="btnApproveHasilCetak" class="btn btn-md btn-flat btn-success" onclick="saveApproveHasilCetak();"><i class="fa fa-check"></i> Approve</button>
                    </center>
                  </div>
                </div>
              </div>
