<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="modal fade" id="modalKirimParsial" role="dialog" tabindex="-1">
        <div class="modal-dialog" style="width:800;">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" data-target="#modalKirimParsial">&times;</button>
              <h3 class="modal-title text-primary">Form Pengiriman</h3>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <div class="row">
                <div class="col-md-12">
                <input type="hidden" name="id_dp" id="id_dp">
                  <table class="table table-responsive table-striped table-bordered" id="tableListOrder">
                    <thead>
                      <th>No Order</th>
                      <th>Jumlah Order</th>
                      <th>Sudah Dikirim</th>
                  ...
                  <h4>Detail Pengiraman</h4>
                  <table class="table table-responsive table-striped table-bordered" id="tableListDetailPengirimanParsial">
                    <thead>
                      <th>Tanggal Kirim</th>
                      <th>Jumlah Kirim</th>
                      <th>Action</th>
              ...
              <div class="form-group col-md-6">
                <div class="input-group date">
                    ...
                    <input type="text" class="form-control" name="tgl_kirim" id="tgl_kirim" placeholder="Tanggal Kirim">
                </div>
              </div>
              <div class="form-group col-md-6">
                <input type="hidden" name="id_dp" id="idDp" class="form-control">
                <input type="hidden" name="noOrder" id="noOrder" class="form-control">
                <input type="text" name="jml_kirim" id="jml_kirim" class="form-control number" placeholder="Jumlah Kirim">
              </div>
              <div class="form-group" style="text-align: center; width: 100%; display: flex; justify-content: center;">
                <button class="btn btn-md btn-flat btn-primary" onclick="kirimBarangParsial()" style="float:left; width:130px;"><i class="fa fa-send"></i> Kirim</button>
              </div>
            </div>
