        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-berder">
              <h4 class="box-title text-blue">History Order Cabang</h4>
              <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalCariHistory" data-backdrop="static" style="margin-left:20px;"><i class="fa fa-search"></i> Cari History Order Cabang</button>
            </div>
            <div class="box-body">
              <div id="dataWrapper" style="display:none;">
                <h4 class="text-blue" id="h4Judul"></h4>
                <table class="table table-responsive table-striped" id="tableListHistoryOrderCabang">
                  <thead>
                    <th>No.</th>
                    <th>Tanggal Pesan</th>
                    <th>Nama Pemesan</th>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title text-blue">Cari History Order Cabang</h4>
              </div>
              ...
              <div class="modal-footer">
                <button type="button" id="btnCariHistory" class="btn btn-md btn-flat btn-success" onclick="searchHistoryOrderCabang();"><i class="fa fa-search"></i> Cari</button>
              </div>
            </div>
          </div>
        </div>
