        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h4 class="box-title text-blue">Lihat Order Baru</h4>
            </div>
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive table-striped" id="tableListOrderBaruCabang">
                    <thead>
                      <th>No.</th>
                      <th>Tanggal</th>
                      <th>Pemesan</th>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content" style="width:1110px;">
              ...
              <div class="modal-footer">
                <button type="button" id="btnApprove" class="btn btn-md btn-flat btn-success"><i class="fa fa-check"></i> Approve</button>
              </div>
            </div>
          </div>
        </div>
