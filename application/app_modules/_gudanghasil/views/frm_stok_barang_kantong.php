<div class="content-wrapper">
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahGudangHasil" onclick="modalTambahBarangBaru('KANTONG')"><i class="fa fa-plus"></i> Tambah Barang Baru</button>
          <button type="button" class="btn btn-md btn-flat btn-warning" data-toggle="modal" data-backdrop="static" data-target="#modalCariHistory" onclick="modalCariHistory('KANTONG')"><i class="fa fa-search"></i> Cari History</button>
          <button type="button" class="btn btn-md btn-flat btn-success" data-toggle="modal" data-backdrop="static" data-target="#modalPengirimanGudangCampur" onclick="modalPengirimanGudang('KANTONG')"><i class="fa fa-plus"></i> Pengiriman</button>
          <button type="button" class="btn btn-md btn-flat btn-danger" data-toggle="modal" data-backdrop="static" data-target="#modalPengembalianCampur" onclick="modalPengembalianBarang('KANTONG')"><i class="fa fa-plus"></i> Tambah Pengembalian Kantong</button>
          <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-backdrop="static" data-target="#modalTambahDataAwal" onclick="modalTambahDataAwalGudangHasil('KANTONG')"><i class="fa fa-plus"></i> Tambah Data Awal</button>
        </div>
        <div class="col-md-12" style="margin-top:10px;">
          <div class="col-md-6" style="display: none;" id="alertKirimanBarangKeKantong">
            <div class="alert alert-info">
              <h4>
                <a href="#" style="text-decoration : none;" data-toggle="modal" data-target="#modalApproveHasilPotong" onclick="modalKirimanDariBagian('KANTONG','POTONG')">
                  Bon Hasil Jadi Untuk Gd. Kantong Sudah Dikirim, Klik Disini Untuk Melihatnya
                </a>
              </h4>
            </div>
          </div>
          <div class="col-md-6" style="display: none;" id="alertApproveReturBarangKantong">
            <a href="#" style="text-decoration : none;" onclick="modalApproveReturBarang('Kantong')">
              <div class="alert alert-info">
        ...
        <div class="col-md-12" style="margin-top:10px;" id="masterContainerHasil">
          <table class="table table-responsive table-striped" id="tableDataMasterGudangHasilKantong">
            <thead>
              <th>Kode</th>
              <th>Ukuran</th>
              <th>Merek</th>
        ...
        <div class="col-md-12" id="historyContainerHasil" style="margin-top:10px; display:none;">
      ...
      <div class="modal fade" id="modalCariHistory" role="dialog" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-md btn-flat btn-success" onclick="cariHistoryGudangHasil('KANTONG')"><i class="fa fa-search"></i> Cari History</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Formulir Pengiriman Gudang Kantong</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <table class="table table-responsive">
                <tr>
                  ...
                  <td>
                    <div class="form-group has-warning">
                      <select class="form-control" id="cmbKeteranganPengiriman">
                        ...
                        <option value="PENGIRIMAN(APAL KANTONG)">APAL KANTONG</option>
              ...
              <div class="col-md-12">
                <h4 class="text-blue">Daftar Pengririman Gudang Hasil Kantong</h4>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Proses Pengembalian Barang Kantong</h4>
            </div>
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
              <div class="row">
                <div class="col-md-12">
                      ...
                      <td>
                        <div class="form-group has-warning">
                          <select class="form-control" id="cmbKeteranganPengembalian">
                            <option value="">--Pilih Keterangan--</option>
                            <option value="PENGEMBALIAN KANTONG (BUKAN KOREKSI)">BUKAN KOREKSI</option>
                            <option value="PENGEMBALIAN KANTONG (KOREKSI)">KOREKSI</option>
                            <option value="PENGEMBALIAN KANTONG (RETUR)">RETUR</option>
                          </select>
                        </div>
                      </td>
                    </tr>
                ...
                <div class="col-md-12">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#HasilPotong" data-toggle="tab" aria-expanded="true" onclick="modalKirimanDariBagian('KANTONG','POTONG')">Hasil Potong</a></li>
                      <li><a href="#HasilSablon" data-toggle="tab" aria-expanded="true" onclick="modalKirimanDariBagian('KANTONG','SABLON')">Hasil Sablon</a></li>
                    </ul>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div style="margin-top:10px;">
                              ...
                              <button type="button" class="btn btn-md btn-flat btn-primary pull-right" onclick="saveApproveKirimanDariBagian('KANTONG','POTONG')"><i class="fa fa-check"></i> Approve All</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="tab-pane" id="HasilSablon">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div style="margin-top:10px;">
                              <button type="button" class="btn btn-md btn-flat btn-danger pull-right" disabled title="Fitur Ini Belum Tersedia"><i class="fa fa-undo"></i> Kirim Balik Ke Potong</button>
                              <button type="button" class="btn btn-md btn-flat btn-primary pull-right" onclick="saveApproveKirimanDariBagian('KANTONG','SABLON')"><i class="fa fa-check"></i> Approve All</button>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="modal fade" id="modalTambahDataAwal" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnSaveDataAwal" class="btn btn-md btn-flat btn-success" onclick="saveDataAwalGudangHasil('KANTONG')"><i class="fa fa-check"></i> Simpan</button>
            </div>
          </div>
        </div>
      </div>
