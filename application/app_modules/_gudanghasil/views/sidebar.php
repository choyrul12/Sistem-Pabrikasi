  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview active">
        <a href="<?php echo $arrParentMenu['Link']; ?>" id="<?php echo $arrParentMenu["Id"]; ?>">
        ...
        <ul class="treeview-menu menu-open" style="display:block;">
          ...
          ?>
          <li><a href="<?php echo base_url().$arrChildMenu['Link']; ?>" id="<?php echo $arrChildMenu["Id"]; ?>"><?php echo $arrChildMenu["Content"]; ?></a></li>
            <?php
              }
            }
          ?>
      ...
      ?>
      <li>
        <a href="<?php echo base_url().$arrParentMenu['Link']; ?>" id="<?php echo $arrParentMenu['Id']; ?>">
