<div class="content-wrapper">
  <section class="content-header">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-header">
              <h3 class="box-title text-blue">Detail History Gudang Spare Part</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-responsive table-striped" id="tableHistoryGudangSparePart">
                    <thead>
                      <th>Kode Accurate</th>
                      <th>Nama Barang</th>
                      <th>Saldo Awal</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnCariHistory" class="btn btn-md btn-flat btn-success" onclick="searchHistoryGudangSparePart()"><i class="fa fa-search"></i> Cari</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <section>
      <div id="modalKeluarMasukSparePart" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-lg" style="width: 1050px;margin: auto; padding-top: 20px;">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header" style="background-color:#00a65a;">
              ...
              <h3 class="modal-title" style="text-align: center; color: black;">&nbsp;&nbsp;Detail History Spare Part</h3>
              <h4 class="modal-title" style="text-align: center; color: black;">&nbsp;&nbsp;<span id="nm_sparePart"></span></h4>
            </div>
            <!-- body modal -->
            <div class="modal-body" style="height:500px; overflow-y:scroll;">
            <div class="content">
              <table class="table table-responsive table-striped table-bordered" id="tableDataKeluarMasukSparePart">
