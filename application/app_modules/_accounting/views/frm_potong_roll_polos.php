        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title text-blue">Potong Ke Roll Polos</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <table class="table table-responsive table-striped" id="tablePotongKeRollPolos">
                    <thead>
                      <th>Tanggal</th>
                      <th>Ukuran</th>
                      <th>Warna</th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" id="btnCariHistory" class="btn btn-md btn-flat btn-success" onclick="searchHistoryPotongKeRollPolos();"><i class="fa fa-search"></i> Cari</button>
            </div>
          </div>
        </div>
      </div>
