<div class="content-wrapper">
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-4">
          <button type="button" class="btn btn-md btn-flat btn-primary btn-block" data-toggle="modal" data-target="#modalCariHasilExtruder" data-backdrop="static"><i class="fa fa-search"></i> Cari Laporan Hasil Extruder</button>
        </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="box box-success">
                  <div class="box-header with-border">
                    <h4 class="modal-title text-blue">Hasil Global <?php echo date("d F Y"); ?></h4>
                  </div>
                  <div class="box-body">
                    <table class="table table-responsive">
                      <tr>
                        <td width="35%">Sisa Shift Sebelumnya</td>
                        <td width="1%">:</td>
