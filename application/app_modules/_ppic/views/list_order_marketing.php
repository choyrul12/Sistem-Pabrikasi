    ...
    <section class="content">
      <div class="box box-primary">
          <div class="box-header">
            <a href="#" class="btn btn-flat btn-md btn-success" onclick="dataTableOrderMarketingTerkirim()">Data Order Terkirim</a>
            <a href="#" class="btn btn-flat btn-md btn-primary" data-toggle="modal" data-target="#modalSearchMarketingOrderBulanan">Cari Order Marketing Per Bulan</a>
            <a href="#" class="btn btn-flat btn-md btn-warning" onclick="dataTableOrderMarketingBulanSebelumnya('<?php echo date("Y-m",strtotime("-1 months")); ?>')">Data Order Bulan Sebelumnya</a>
          </div>
          <div class="box-body">
            <table class="table table-responsive table-striped" id="table-order-marketing">
              <thead>
                <tr>
            ...
            <table class="table table-responsive table-striped" id="tableOrderMarketingTerkirim" style="display:none;">
              <thead>
      ...
      <div class="modal fade" id="modalSearchMarketingOrderBulanan" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" data-target="#modalSearchMarketingOrderBulanan">&times;</button>
              <h4 class="modal-title text-info">Cari Data Order Marketing Per Bulan</h4>
            </div>
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  <button type="button" id="btnSearchMarketingOrder" class="btn btn-flat btn-block btn-info" onclick="dataTableOrderMarketingBulanan()">
                    Cari Order Marketing
                  </button>
                </div>
              </div>
            </div>
