<html>
  ...
  <body>
    <div>
      <div class="header">
        <h3 class="h3"><b>Laporan Bon Hasil Cetak</b></h3>
      ...
      <div>
        <table style="border:0px solid #4a4a4a; font-size:11pt;" width='100%'>
          <tr style="border-bottom:1px solid #4a4a4a;">
            ...
            <td align="center" style="border-bottom:1px solid #4a4a4a;" width="10%">Jenis</td>
            <td align="center" style="border-bottom:1px solid #4a4a4a;" width="10%">Nama Operator</td>
            <td align="center" style="border-bottom:1px solid #4a4a4a;" width="10%">Status</td>
          </tr>
          <?php
          ...
          ?>
            <tr>
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["merek"]; ?></td>
              ...
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["jumlah_selesai"]; ?></td>
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["bobin"]; ?></td>
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["payung"]; ?></td>
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["payung_kuning"]; ?></td>
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["jns_brg"]; ?></td>
              <td align="center" style="border-bottom:1px solid #4a4a4a; padding-top:3px;" width="10%"><?php echo $value["nama_operator"]; ?></td>
