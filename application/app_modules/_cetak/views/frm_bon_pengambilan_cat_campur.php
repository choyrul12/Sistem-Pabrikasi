        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <button type="button" class="btn btn-md btn-flat btn-primary" data-toggle="modal" data-target="#modalCariBonPengambilanBahan" data-backdrop="static"><i class="fa fa-search"></i> Cari Bon Pengambilan Cat Campur</button>
            </div>
            <div class="box-body">
              <div class="row">
                <div class="col-md-12" id="bonPengambilanBahan" style="display:none;">
                  <h3 class="text-blue">Bon Pengambilan Cat Campur</h3>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-blue">Cari Data Bon Pengambilan Cat Campur</h4>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" id="btnSearch" class="btn btn-md btn-flat btn-success" onclick="searchBonPengambilanBahan('Cat_Campur');"><i class="fa fa-search"></i> Cari</button>
            </div>
          </div>
        </div>
      </div>
