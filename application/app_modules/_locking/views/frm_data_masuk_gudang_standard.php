      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <div class="box-title">
              <h4 class="text-primary">Detail Gudang Standard</h4>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-md btn-flat btn-success" onclick="searchDataGudangHasil('STANDARD')">Cari</button>
          </div>
        </div>
      </div>
    </div>
