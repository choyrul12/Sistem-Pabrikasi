    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            <table class="table table-responsive table-striped" id="tablePengambilanPotong">
              <thead>
                <th>No</th>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title text-blue">Cari Barang Extruder Yang Diambil Potong</h4>
          </div>
          ...
          <div class="modal-footer">
            <button type="button" id="btnCariPengambilanPotong" class="btn btn-md btn-flat btn-success" onclick="searchPengambilanPotongExtruder()"><i class="fa fa-search"></i> Cari Barang</button>
          </div>
        </div>
      </div>
    </div>
